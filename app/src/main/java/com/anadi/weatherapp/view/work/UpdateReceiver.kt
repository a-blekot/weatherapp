...
import com.anadi.weatherapp.domain.location.UpdateAllLocationsUseCase
import com.anadi.weatherapp.utils.WeatherException
            ...
            GlobalScope.launch {
                try {
                    ...
                    val mainIntent = Intent().apply {
                        setClassName(
                                "com.anadi.weatherapp",
                                "com.anadi.weatherapp.view.ui.mainactivity.MainActivity"
                        )
